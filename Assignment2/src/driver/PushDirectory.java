...
/**
 * Push the current working directory in the directory stack
 * @author Iangola Andrianarison
 * @author Yena Lee
 * @author Andrey Zhuravlev
 * @author Su Tong Kong
...
public class PushDirectory {
	...
	/**
	 * Pushes current working directory onto the stack
	 * 
	 */
	public void saveCurrentDirectory(DirectoryStack dirStack, Directory curdir) {
